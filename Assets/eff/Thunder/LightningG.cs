...
namespace Effects
{
    ...
    public class LightningG : MonoBehaviour
    {
        ...
        void OnSpawned()
        {
            ...
            //if (Oscillate && Points > 0)
                //OscillateTimerID = EffectTime.time.AddTimer(OscillateTime, OnOscillate);
        ...
        void OnDespawned()
        {
            ...
            if (FrameTimerID != -1)
            {
                ThunderTime.time.RemoveTimer(FrameTimerID);
                FrameTimerID = -1;
            }
            ...
            {
                ThunderTime.time.RemoveTimer(OscillateTimerID);
                OscillateTimerID = -1;
            }
        }
        ...
        void Animate()
        {
            ...
            // Add timer 
            //FrameTimerID = EffectTime.time.AddTimer(FrameStep, OnFrameStep);
